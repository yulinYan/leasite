<template>
	<div class="systemMenu">
		...
		<el-dialog ref="xhzqDialog" class="xhzqDialog" :title="chioceMenus.name" :fullscreen="isfullscreen" :modal="false" :visible.sync="dialogVisible"  :append-to-body="true" :close-on-click-modal="false" :destroy-on-close="true" :show-close="false" :width="width" :class="isminimize? 'isminimize': ''" center>
		...
		data() {
			return {
				...
				systemMenus:[//系统菜单项目
					...
					{ name:'退出系统',path:'/gerenzhongxin',icon:require("../assets/img/tuichu.png")},
				],
				systemModules:[//系统功能模块
					{ name:'用户中心',path:'/baseForm',icon:require("../assets/img/yonghuzhongxin.png")},
					{ name:'物联网中心',path:'/gerenzhongxin',icon:require("../assets/img/wulianwang.png")},
					{ name:'运维中心',path:'/gerenzhongxin',icon:require("../assets/img/yunweizhongxin.png")},
				],	
				chioceMenus:{}//点击选中的菜单信息
			}
		},
		created() {
			//this.openDialog();
