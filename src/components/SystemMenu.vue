<template>
	<div class="systemMenu">
		...
		<el-dialog ref="xhzqDialog" class="xhzqDialog" :title="chioceMenus.name" :fullscreen="isfullscreen" :modal="false" :visible.sync="dialogVisible"  :append-to-body="true" :close-on-click-modal="false" :destroy-on-close="true" :show-close="false"  :class="isminimize? 'isminimize': ''" center>
		...
		data() {
			return {
				...
				systemMenus:[//系统菜单项目
					...
					{ name:'退出系统',path:'',icon:require("../assets/img/tuichu.png")},
				],
